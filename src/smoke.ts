...
async function main() {
  ...
  await section("Billing: Stripe webhook signature verification (spec-correct, offline)", async () => {
  ...
  await section("Billing: purchase store (memory + durable file) drives the entitlements gate", async () => {
  ...
  await section("Billing: HTTP handler (checkout + webhook fulfillment, no network)", async () => {
  ...
  await section("Billing: mounted on the web adapter over a real loopback socket", async () => {
  ...
  await section("Rules engine: conditions library (normalize, validate, describe)", async () => {
  ...
  await section("Rules engine: monster stat blocks + bundled bestiary", async () => {
  ...
  await section("Rules engine: combat / initiative order (pure, deterministic)", async () => {
  ...
  await section("Rules engine: monsters as damage targets + monster-aware markers (fully isolated)", async () => {
